...
carbig = input("How big do you want your car to be? ")
TireNum = input("How many tires would you like your car to have? ")
#update this code below to show your two new properties from above
c1 = Car(doors, color, hp, carbig, TireNum)
...
print("It will be", c1.big, " Big.")
print("It will have", c1.numOfTire, "Tires.")
